...
namespace Flan {
    struct MemoryManagerHeader
    {
        ...
        MemoryManagerHeader(const u32 size, bool allocated)
        {
            //Set chunk size
    ...
    void DynamicAllocator::init(u32 size)
    {
    ...
    void* DynamicAllocator::reallocate(void* pointer, u32 size, u32 align)
    {
#ifdef NORMAL_ALLOC
        (void)align;
